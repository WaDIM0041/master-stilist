/* ─────────────────────────────────────────────
   Master Stilist — единый контент платформы
   ───────────────────────────────────────────── */
...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    num: "007",
    cat: "pro",
    title: "STILIST PRO для мастеров",
    price: "от 990 ₽/мес",
    note: "первые 14 дней — 0 ₽",
    desc: "Кабинет бьюти-мастера: автоматические разборы под вашей маркой, база клиентов, палитры и PDF на вашем бланке.",
  },
  {
    id: "partner",
    num: "008",
    cat: "pro",
    title: "«Льняной путь» · партнёрство",
    price: "по договору",
    note: "для брендов одежды",
    desc: "Коллекции, проверенные палитрами наших клиентов: витрина в разборах, промокоды, аналитика спроса.",
  },
];
...
export const PROCESS_STEPS = [
  {
    ...
    title: "Бриф",
    time: "10 минут",
    text: "Анкета из двенадцати вопросов: образ жизни, референсы, ограничения. Алгоритм приступает к работе сразу после отправки.",
  },
  {
    num: "02",
    title: "Анализ",
    time: "до 24 часов",
    text: "Считываем цветотип, уровень контраста и пропорции. Машина считает — стилист-колорист проверяет каждый вывод вручную.",
  },
  {
    num: "03",
    title: "Карта стиля",
...
export const TESTIMONIALS = [
  ...
  {
    name: "Алина",
    meta: "29 · мастер, STILIST PRO",
    quote:
      "Запустила разборы под своей маркой. Средний чек вырос на сорок процентов, а клиенты наконец перестали спрашивать «а мне точно идёт?».",
  },
];
