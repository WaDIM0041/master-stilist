        ...
        <div className="grid gap-8 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5 lg:col-start-7">
            <p
              ...
              data-reveal
            >
              Алгоритм считает — эксперт проверяет. Каждый вывод вручную
              верифицирует стилист-колорист, поэтому разбор читается как
              рекомендация человека, а не как распечатка калькулятора.
            </p>
          </div>
        </div>
